 ...
 */
#line 115 "ifxConnection.ec"
#line 116 "ifxConnection.ec"
  char *ec_database = 0;
  char *ec_username = 0;
  char *ec_password = 0;
  char *ec_connName = 0;
 ...
 */
#line 132 "ifxConnection.ec"
  {
#line 132 "ifxConnection.ec"
  ifx_conn_t      *_sqiconn;
  _sqiconn = (ifx_conn_t *)ifx_alloc_conn_user(ec_username, ec_password);
  sqli_connect_open(ESQLINTVERSION, 0, ec_database, ec_connName, _sqiconn, 0);
 ...
 *   EXEC SQL BEGIN DECLARE SECTION;
 */
#line 178 "ifxConnection.ec"
#line 179 "ifxConnection.ec"
  char *ec_connName = 0;
/*
 *   EXEC SQL END DECLARE SECTION;
 */
#line 180 "ifxConnection.ec"
 ...
 */
#line 184 "ifxConnection.ec"
  {
#line 184 "ifxConnection.ec"
  sqli_connect_close(0, ec_connName, 0, 0);
#line 184 "ifxConnection.ec"
  }
