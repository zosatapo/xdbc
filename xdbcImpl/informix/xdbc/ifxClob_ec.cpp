...
//-------------------------------------------------------------------------
IfxClob::IfxClob(IfxConnection* ora_conn):Clob()
{
  __mp_conn=ora_conn;

}

IfxClob::IfxClob(IfxConnection* ora_conn,const string& lob_str):Clob()
{
  __mp_conn=ora_conn;
}

IfxClob::IfxClob(IfxConnection* ora_conn,struct ifx_lo_ts* p_ec_lo_ts)
{
  __mp_conn=ora_conn;
...
IfxClob::IfxClob(IfxConnection* ora_conn,struct tag_loc_t* p_ec_locator):Clob()
{
  __mp_conn=ora_conn;
...
int IfxClob::length(__XDBC_HOOK_DECLARE_ONCE) const   __XDBC_THROW_DECLARE(SQLException)
{
  return (int)lob_stream.length();
}

int IfxClob::write(__XDBC_HOOK_DECLARE_MORE int pos, const string& str)  __XDBC_THROW_DECLARE(SQLException)
{
...
int IfxClob::write(__XDBC_HOOK_DECLARE_MORE int pos, const char* str, int offset, int len)  __XDBC_THROW_DECLARE(SQLException)
{
...
int IfxClob::read(__XDBC_HOOK_DECLARE_MORE int pos, char* str,int offset,int length) const  __XDBC_THROW_DECLARE(SQLException)
{
...
void IfxClob::truncate(__XDBC_HOOK_DECLARE_MORE int len)  __XDBC_THROW_DECLARE(SQLException)
{
  lob_stream.resize(len);
}

void IfxClob::swap(IfxClob& clob)
{
  ...
  lob_stream.swap(clob.lob_stream);
}
