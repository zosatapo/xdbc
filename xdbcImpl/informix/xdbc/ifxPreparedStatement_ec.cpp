#include <sqlhdr.h>
#include <sqliapi.h>
#line 1 "ifxPreparedStatement.ec"
 ...
 */
#line 98 "ifxPreparedStatement.ec"
#line 99 "ifxPreparedStatement.ec"
  char *ec_select_sql;
  char *ec_cursor_id;
/*
 *   EXEC SQL END DECLARE SECTION;
 */
#line 101 "ifxPreparedStatement.ec"
 ...
 */
#line 106 "ifxPreparedStatement.ec"
  {
#line 106 "ifxPreparedStatement.ec"
 ...
 *   EXEC SQL BEGIN DECLARE SECTION;
 */
#line 119 "ifxPreparedStatement.ec"
#line 120 "ifxPreparedStatement.ec"
  char *ec_cursor_name;
  char *ec_cursor_id;
/*
 *   EXEC SQL END DECLARE SECTION;
 */
#line 122 "ifxPreparedStatement.ec"
 ...
 */
#line 129 "ifxPreparedStatement.ec"
  {
#line 129 "ifxPreparedStatement.ec"
 ...
 *     EXEC SQL DECLARE :ec_cursor_name SCROLL CURSOR FOR :ec_cursor_id ;
 */
#line 133 "ifxPreparedStatement.ec"
  {
#line 133 "ifxPreparedStatement.ec"
  sqli_curs_decl_dynm(ESQLINTVERSION, sqli_curs_locate(ESQLINTVERSION, ec_cursor_name, 0), ec_cursor_name, sqli_curs_locate(ESQLINTVERSION, ec_cursor_id, 1), 32, 0);
#line 133 "ifxPreparedStatement.ec"
 ...
 */
#line 137 "ifxPreparedStatement.ec"
  {
#line 137 "ifxPreparedStatement.ec"
 ...
 */
#line 142 "ifxPreparedStatement.ec"
  {
#line 142 "ifxPreparedStatement.ec"
 ...
 */
#line 146 "ifxPreparedStatement.ec"
  {
#line 146 "ifxPreparedStatement.ec"
  sqli_curs_open(ESQLINTVERSION, sqli_curs_locate(ESQLINTVERSION, ec_cursor_name, 256), __mp_ec_sqlda_vars, (char *)0, (struct value *)0, 1, 0);
#line 146 "ifxPreparedStatement.ec"
  }
  }
 ...
 *   EXEC SQL BEGIN DECLARE SECTION;
 */
#line 175 "ifxPreparedStatement.ec"
#line 176 "ifxPreparedStatement.ec"
  char *ec_cursor_name;
  char *ec_cursor_id;
/*
 *   EXEC SQL END DECLARE SECTION;
 */
#line 178 "ifxPreparedStatement.ec"
 ...
 */
#line 185 "ifxPreparedStatement.ec"
  {
#line 185 "ifxPreparedStatement.ec"
 ...
 */
#line 189 "ifxPreparedStatement.ec"
  {
#line 189 "ifxPreparedStatement.ec"
  sqli_exec(ESQLINTVERSION, sqli_curs_locate(ESQLINTVERSION, ec_cursor_id, 257), __mp_ec_sqlda_vars, (char *)0, (struct value *)0, (ifx_sqlda_t *)0, (char *)0, (struct value *)0, 0);
#line 189 "ifxPreparedStatement.ec"
  }
  }
 ...
 *   EXEC SQL BEGIN DECLARE SECTION;
 */
#line 609 "ifxPreparedStatement.ec"
#line 610 "ifxPreparedStatement.ec"
  char *ec_cursor_id;
/*
 *   EXEC SQL END DECLARE SECTION;
 */
#line 611 "ifxPreparedStatement.ec"

  ec_cursor_id    = (char*) __ms_cursor_id.c_str();
/*
 *   EXEC SQL FREE :ec_cursor_id;
 */
#line 613 "ifxPreparedStatement.ec"
  {
#line 613 "ifxPreparedStatement.ec"
 ...
 *   EXEC SQL BEGIN DECLARE SECTION;
 */
#line 772 "ifxPreparedStatement.ec"
#line 773 "ifxPreparedStatement.ec"
  char *ec_select_sql;
  char *ec_cursor_id;
/*
 *   EXEC SQL END DECLARE SECTION;
 */
#line 775 "ifxPreparedStatement.ec"
 ...
 *   EXEC SQL PREPARE :ec_cursor_id FROM :ec_select_sql;
 */
#line 780 "ifxPreparedStatement.ec"
  {
#line 780 "ifxPreparedStatement.ec"
  sqli_prep(ESQLINTVERSION, ec_cursor_id, ec_select_sql,(ifx_literal_t *)0, (ifx_namelist_t *)0, -1, 0, 0 ); 
#line 780 "ifxPreparedStatement.ec"
 ...
 */
#line 784 "ifxPreparedStatement.ec"
  {
#line 784 "ifxPreparedStatement.ec"
  sqli_describe_input_stmt(ESQLINTVERSION, sqli_curs_locate(ESQLINTVERSION, ec_cursor_id, 257), &__mp_ec_sqlda_vars, 0);
#line 784 "ifxPreparedStatement.ec"
  }
 ...
 *   EXEC SQL FREE  :ec_cursor_id;
 */
#line 788 "ifxPreparedStatement.ec"
  {
#line 788 "ifxPreparedStatement.ec"
  sqli_curs_free(ESQLINTVERSION, sqli_curs_locate(ESQLINTVERSION, ec_cursor_id, 258));
#line 788 "ifxPreparedStatement.ec"
 ...
 *   EXEC SQL BEGIN DECLARE SECTION;
 */
#line 800 "ifxPreparedStatement.ec"
#line 801 "ifxPreparedStatement.ec"
  char *ec_select_sql;
  char *ec_cursor_id;
/*
 *   EXEC SQL END DECLARE SECTION;
 */
#line 803 "ifxPreparedStatement.ec"
 ...
 *   EXEC SQL PREPARE :ec_cursor_id FROM :ec_select_sql;
 */
#line 808 "ifxPreparedStatement.ec"
  {
#line 808 "ifxPreparedStatement.ec"
  sqli_prep(ESQLINTVERSION, ec_cursor_id, ec_select_sql,(ifx_literal_t *)0, (ifx_namelist_t *)0, -1, 0, 0 ); 
#line 808 "ifxPreparedStatement.ec"
 ...
 */
#line 812 "ifxPreparedStatement.ec"
  {
#line 812 "ifxPreparedStatement.ec"
  sqli_describe_stmt(ESQLINTVERSION, sqli_curs_locate(ESQLINTVERSION, ec_cursor_id, 257), &__mp_ec_sqlda_vars, 0);
#line 812 "ifxPreparedStatement.ec"
  }
  int __SQLCODE = SQLCODE;
  string __SQLSTATE = SQLSTATE;
 ...
 *   EXEC SQL FREE  :ec_cursor_id;
 */
#line 816 "ifxPreparedStatement.ec"
  {
#line 816 "ifxPreparedStatement.ec"
  sqli_curs_free(ESQLINTVERSION, sqli_curs_locate(ESQLINTVERSION, ec_cursor_id, 258));
#line 816 "ifxPreparedStatement.ec"
 ...
 *   EXEC SQL BEGIN DECLARE SECTION;
 */
#line 841 "ifxPreparedStatement.ec"
#line 842 "ifxPreparedStatement.ec"
  char *ec_select_sql;
  char *ec_cursor_id;
/*
 *   EXEC SQL END DECLARE SECTION;
 */
#line 844 "ifxPreparedStatement.ec"
 ...
 *   EXEC SQL PREPARE :ec_cursor_id FROM :ec_select_sql;
 */
#line 849 "ifxPreparedStatement.ec"
  {
#line 849 "ifxPreparedStatement.ec"
  sqli_prep(ESQLINTVERSION, ec_cursor_id, ec_select_sql,(ifx_literal_t *)0, (ifx_namelist_t *)0, -1, 0, 0 ); 
#line 849 "ifxPreparedStatement.ec"
 ...
 *   EXEC SQL DESCRIBE :ec_cursor_id into __mp_ec_sqlda_vars;
 */
#line 853 "ifxPreparedStatement.ec"
  {
#line 853 "ifxPreparedStatement.ec"
  sqli_describe_stmt(ESQLINTVERSION, sqli_curs_locate(ESQLINTVERSION, ec_cursor_id, 257), &__mp_ec_sqlda_vars, 0);
#line 853 "ifxPreparedStatement.ec"
 ...
 *   EXEC SQL FREE  :ec_cursor_id;
 */
#line 857 "ifxPreparedStatement.ec"
  {
#line 857 "ifxPreparedStatement.ec"
  sqli_curs_free(ESQLINTVERSION, sqli_curs_locate(ESQLINTVERSION, ec_cursor_id, 258));
#line 857 "ifxPreparedStatement.ec"
...
#line 1107 "ifxPreparedStatement.ec"
